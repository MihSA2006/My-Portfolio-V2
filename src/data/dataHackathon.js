...
export const hackathons = [
  {
    ...
    descriptionFr:
      "Concours d'algorithmique organisé par DSA (Data Structure and Algorithm) à l'INSI.",
    year: "2026",
  ...
  {
    id: 2,
    title: "Algo Tournament - Data Day INSI 3rd Edition",
    organization: "INSI",
    role: "Algorithmic Contest",
    prizeEn: "2nd Place",
    prizeFr: "2e Place",
    descriptionEn:
      "Algorithm contest organized by INSI during the Data Day event.",
    descriptionFr:
      "Concours d'algorithmique organisé par l'INSI pendant l'événement Data Day.",
    year: "2026",
    location: "INSI, Madagascar",
    icon: TrophyIcon,
    achievements: ["Algorithms", "Problem Solving"],
  },
  {
    id: 3,
    ...
    descriptionFr:
      "Application web utilisant l'IA pour suggérer des idées de business et suivre leur évolution.",
    year: "2025",
  ...
  },
  {
    ...
    descriptionFr:
      "Résolution d'algorithmes complexes en Python sous des contraintes de temps.",
    year: "2025",
    location: "Madagascar",
  ...
  },
  {
    ...
    prizeFr: "Participation",
    descriptionEn:
      "Web application for tracking pig breeds and managing agricultural farms.",
    descriptionFr:
      "Application de suivi des races de porcs et de gestion des exploitations agricoles.",
    year: "2025",
