...
export const fr = {
  ...
  skills: {
    ...
    defaultDescription:
      "Développeur full-stack passionné créant des expériences web et mobiles modernes avec des technologies de pointe et les meilleures pratiques.",
  ...
  contact: {
    ...
    description:
      "Vous avez des questions ou vous êtes prêt à transformer votre entreprise avec l'IA ?",
    fields: {
      name: "Votre Nom",
      email: "Votre Email",
